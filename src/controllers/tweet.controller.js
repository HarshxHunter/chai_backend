...
const createTweet = asyncHandler(async (req, res) => {
    ...
    // create tweet with content and user._id and save
...
const getUserTweets = asyncHandler(async (req, res) => {
    ...
    // can be done using this but this gets only tweets
    // const tweets = await Tweet.find({owner: userId}).sort({createdAt: -1});
    // aggregate method gets tweets and user details and likes on each tweet
